...
desc 'Generate documentation for the dropdown_variants extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'DropdownVariantsExtension'
...
desc 'Test the dropdown_variants extension.'
...
namespace :test do
  desc 'Functional test the dropdown_variants extension.'
  ...
  desc 'Unit test the dropdown_variants extension.'
